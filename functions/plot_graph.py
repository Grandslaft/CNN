...
def show_graph(X, array_acc, array_val_acc, label_1='1', label_2='2', smooth_1=0, smooth_2=0, title='title', xaxis_label='x', yaxis_label='y'):
    tck = interpolate.splrep(X, array_acc[0], k = 3, s = smooth_1)
    accuracy_smoothed = interpolate.splev(X, tck, der = 0)

    tck = interpolate.splrep(X, array_val_acc[0], k = 3, s = smooth_2)
